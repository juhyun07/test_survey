            ...
            <table className="min-w-full divide-y divide-gray-200 border-collapse">
              <thead className="bg-gray-50">
                <tr>
                  ...
                  {props.columns.map((column: ColumnGroup) => (
                    <th 
                      key={column.id} 
                ...
                <tr>
                  ...
                  {props.columns.flatMap((column: ColumnGroup) => 
                    column.subColumns.map((subCol: SubColumn) => (
              ...
              <tbody className="bg-white divide-y divide-gray-200">
                {rows.map((row: {id: string, label: string}) => (
                  <tr key={row.id}>
                    ...
                    {props.columns.flatMap((col: ColumnGroup) => 
